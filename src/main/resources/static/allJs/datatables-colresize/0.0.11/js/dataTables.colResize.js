        ...
        ColResize.prototype = {
            ...
            "_fnResizeHandleCheck": function (e, nTh) {
                ...
                if ($(nTh).prev("th").length == 0) {
                    if (this.s.init.rtl){rightHandleOn = false;} else {leftHandleOn = false;}
                }
                ...
                if ($(nTh).next("th").length == 0 && this.s.init.tableWidthFixed) {
                    if (this.s.init.rtl){leftHandleOn = false;} else {rightHandleOn = false;}
                }
                ...
                if (resizeAvailable) {
                    ...
                    if (!that.s.isMousedown){//Restore click event if mouse is not down
